...
export default function HowToUse() {
    return (
        <div className="pointer-events-auto w-full h-screen flex justify-center items-center bg-gradient-to-br ">
            <Link
                href="/"
            ...
            <div className="bg-[rgba(243,244,246,0.85)] w-[95%] h-[85%] shadow-xl rounded-2xl p-8 max-w-3xl overflow-auto space-y-12 mt-8">
