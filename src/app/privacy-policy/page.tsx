    ...
    return (
        <div className="w-full h-screen flex flex-col justify-center items-center relative">
            <div className="w-full max-w-[1000px] h-full flex flex-col justify-center items-center relative">
                ...
                {/* プライバシーポリシーのコンテンツ */}
                <div className="pointer-events-auto w-[90%] max-w-[1000px] max-h-[80%] mx-auto px-6 py-12 bg-white shadow-lg rounded-lg h-[80vh] overflow-y-auto mt-[100px]">
                    <h1 className="text-2xl font-bold text-center mb-6">プライバシーポリシー</h1>
